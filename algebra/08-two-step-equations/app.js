...
const a=num(2,3),b=num(3,4),c=num(4,19); if(a===0) stop('a must not be zero.'); const x=(c-b)/a; console.log(`${a}x + ${b} = ${c}`); console.log(`${a}x = ${c-b}`); console.log(`x = ${fmt(x)}`); console.log(`Check: ${fmt(a*x+b)} = ${c}`);
