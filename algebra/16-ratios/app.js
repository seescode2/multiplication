...
const a=Math.trunc(num(2,12)),b=Math.trunc(num(3,18)); if(b===0) stop('The second ratio amount must not be zero.'); const g=gcd(a,b); console.log(`${a}:${b} simplifies to ${a/g}:${b/g}`); console.log(`Both parts were divided by ${g}.`);
