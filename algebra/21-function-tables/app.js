...
const m=num(2,3),b=num(3,-2),lo=Math.trunc(num(4,-2)),hi=Math.trunc(num(5,2)); console.log(`Rule: y = ${m}x + ${b}`); console.log(' x | y\n---+---'); range(lo,hi).forEach(x=>console.log(`${String(x).padStart(2)} | ${fmt(m*x+b)}`));
