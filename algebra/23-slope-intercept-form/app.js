...
const m=num(2,2),b=num(3,1); console.log(`Line: y = ${m}x + ${b}`); range(-2,2).forEach(x=>console.log(`(${x}, ${fmt(m*x+b)})${x===0?' ← y-intercept':''}`)); console.log(`Each step right changes y by ${m}.`);
