...
const force = numberArg(2, 12, "force");
const lightMass = positiveArg(3, 2, "first mass");
const heavyMass = positiveArg(4, 6, "second mass");
for (const mass of [lightMass, heavyMass]) {
  console.log(`${force} N pushing ${mass} kg -> ${(force / mass).toFixed(2)} m/s²`);
}
