...
const force = Math.abs(numberArg(2, 30, "push force"));
const massA = positiveArg(3, 50, "mass A");
const massB = positiveArg(4, 75, "mass B");
console.log(`A  <- ${force} N | ${force} N ->  B`);
console.log(`A accelerates left at ${(force / massA).toFixed(2)} m/s².`);
console.log(`B accelerates right at ${(force / massB).toFixed(2)} m/s².`);
