...
const force = numberArg(2, 8, "force");
const distance = nonnegativeArg(3, 5, "distance");
console.log(`Work = ${force} N × ${distance} m = ${(force * distance).toFixed(2)} J`);
showBar(Math.abs(force * distance), "work");
