...
const mass = positiveArg(2, 3, "mass");
const height = nonnegativeArg(3, 4, "height");
const energy = mass * 9.8 * height;
console.log(`GPE = mass × gravity × height`);
console.log(`${mass} kg × 9.8 m/s² × ${height} m = ${energy.toFixed(2)} J`);
