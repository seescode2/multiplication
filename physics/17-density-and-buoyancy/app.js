...
const mass = nonnegativeArg(2, 500, "mass");
const volume = positiveArg(3, 750, "volume");
const density = mass / volume;
const result = density < 1 ? "float" : density > 1 ? "sink" : "stay neutrally buoyant";
console.log(`Density = ${mass} g ÷ ${volume} cm³ = ${density.toFixed(3)} g/cm³`);
console.log(`In water, it should ${result} in this simple model.`);
