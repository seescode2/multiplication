...
const quiet = positiveArg(2, 1, "quiet amplitude");
const loud = positiveArg(3, 4, "loud amplitude");
for (const amplitude of [quiet, loud]) {
  console.log(`amplitude ${amplitude}: ${"<" + "=".repeat(Math.min(30, Math.round(amplitude * 4))) + ">"}`);
  console.log(`relative intensity: ${(amplitude ** 2).toFixed(2)}`);
}
