...
const angle = numberArg(2, 35, "angle");
if (angle < 0 || angle > 90) fail("angle must be from 0 to 90 degrees");
console.log(`incoming ray  \ ${angle}°`);
console.log("--------------- mirror");
console.log(`reflected ray / ${angle}°`);
console.log(`Angle in = ${angle}°; angle out = ${angle}°.`);
