...
const voltage = numberArg(2, 9, "voltage");
const resistance = positiveArg(3, 3, "resistance");
const current = voltage / resistance;
console.log(`┌──[ ${resistance} Ω ]──┐`);
console.log(`│   ${current.toFixed(2)} A     │`);
console.log(`└──| ${voltage} V |────┘`);
console.log(`Current = ${voltage} V ÷ ${resistance} Ω = ${current.toFixed(2)} A`);
