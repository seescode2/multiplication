...
SOH-CAH-TOA is a memory tool: sine uses Opposite/Hypotenuse, cosine uses Adjacent/Hypotenuse, and tangent uses Opposite/Adjacent.

## Learning goal

Compare all three ratios in one triangle.
